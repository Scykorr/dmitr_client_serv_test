...
class Ui_Form_server(object):
    def setupUi(self, Form_server):
        ...
        self.radioButton_common_test = QtWidgets.QRadioButton(Form_server)
        self.radioButton_common_test.setGeometry(QtCore.QRect(10, 10, 91, 17))
        self.radioButton_common_test.setObjectName("radioButton_common_test")
        self.radioButton_standart_bliz_test = QtWidgets.QRadioButton(Form_server)
        self.radioButton_standart_bliz_test.setGeometry(QtCore.QRect(10, 30, 151, 17))
        self.radioButton_standart_bliz_test.setChecked(True)
        self.radioButton_standart_bliz_test.setObjectName("radioButton_standart_bliz_test")
    ...
    def retranslateUi(self, Form_server):
        ...
        self.radioButton_common_test.setText(_translate("Form_server", "Общий тест"))
        self.radioButton_standart_bliz_test.setText(_translate("Form_server", "Стандартный блиц тест"))

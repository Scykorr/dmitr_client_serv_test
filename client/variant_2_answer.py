...
from GUIpy.variant_2_answer.zadanie1_part1_var2 import Ui_Zadanie1_part1
from GUIpy.variant_2_answer.zadanie2_part1_var2 import Ui_Zadanie2_part1
from GUIpy.variant_2_answer.zadanie3_4_5_part1_var2 import Ui_Zadanie3_4_5_part1_var1
from GUIpy.variant_2_answer.zadanie6_part1_var2 import Ui_Zadanie6_part1_var1
from GUIpy.variant_2_answer.zadanie7_part1_var2 import Ui_Zadanie7_part1_var1
from GUIpy.variant_2_answer.zadanie8_part1_var2 import Ui_Zadanie8_part1_var1
from GUIpy.variant_2_answer.zadanie1_2_3_part2_var2 import Ui_Zadanie1_2_3_part2_var1
from GUIpy.variant_2_answer.zadanie4_part2_var2 import Ui_Zadanie4_part2_var1
...
class Task123Part2Var2(QtWidgets.QWidget):
    ...
    def set_default_vals(self):
        ...
        self.ui_form.lineEdit_18.setText('1')
        self.ui_form.lineEdit_19.setText('3')
        self.ui_form.lineEdit_20.setText('5')
        self.ui_form.lineEdit_21.setText('7')
        self.ui_form.lineEdit_22.setText('9')
        self.ui_form.lineEdit_23.setText('10')
        self.ui_form.lineEdit_24.setText('11')
        self.ui_form.lineEdit_25.setText('12')
        self.ui_form.lineEdit_26.setText('13')
        self.ui_form.lineEdit_27.setText('14')
        self.ui_form.lineEdit_28.setText('15')
        self.ui_form.lineEdit_29.setText('17')
        self.ui_form.lineEdit_30.setText('22')
        self.ui_form.lineEdit_31.setText('23')
        self.ui_form.lineEdit_32.setText('29')
        self.ui_form.lineEdit_33.setText('36')
        self.ui_form.lineEdit_34.setText('42')

    def main_select(self, user_name, ip_address_server):
        vals1 = []
        answer = Client(ip_address_server, 7000).connect(
            f"select answer_user from zadanie_variant where num_zadanie=1 and user_name='{user_name}' "
            f"and num_part=2 and variant=2")
        for el in answer:
            vals1.append(el)
        val = vals1[0][0].split(';')
    ...
    def check_values(self):
        ...
        if self.ui_form.lineEdit_4.text() != self.ui_form.lineEdit_21.text():
...
class Task4Part2Var2(QtWidgets.QWidget):
    ...
    def set_default_vals(self):
        self.ui_form.lineEdit_3.setText('26')
        self.ui_form.lineEdit_4.setText('1')
    ...
    def check_values(self):
        if self.ui_form.lineEdit.text() != self.ui_form.lineEdit_3.text():
            self.ui_form.lineEdit.setStyleSheet("QLineEdit {background-color: red;}")
...
class Task5Part2Var2(QtWidgets.QWidget):
    ...
    def set_default_vals(self):
        ...
        self.ui_form.lineEdit_answer_10.setText('2')
...
class Task6Part2Var2(QtWidgets.QWidget):
    ...
    def set_default_vals(self):
        self.ui_form.lineEdit_answer_11.setText('9')
        self.ui_form.lineEdit_answer_12.setText('4')
        self.ui_form.lineEdit_answer_13.setText('6')
        self.ui_form.lineEdit_answer_14.setText('1')
        self.ui_form.lineEdit_answer_15.setText('2')
        self.ui_form.lineEdit_answer_16.setText('10')
        self.ui_form.lineEdit_answer_17.setText('8')
        self.ui_form.lineEdit_answer_18.setText('3')
        self.ui_form.lineEdit_answer_19.setText('7')
        self.ui_form.lineEdit_answer_20.setText('5')
